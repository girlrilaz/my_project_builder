...
class ModelName(BaseModel):
    ...
    def build(self):
        ...
        """
        Create the model with predefined initial parameters, user can overwright it by passing kw args in train
        """
        init_params = vars(self.model_params) #set in config

        # TODO:
        #self.init_model = f"set model with {init_params} here"
